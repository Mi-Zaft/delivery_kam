              ...
              children: [
                      ...
                      children: [
                        ...
                        Expanded(
                            child: DeliveryAuthConfirmCodeTextfield(
                                ...
                                isError: isError,
                                onChanged: (value) {
                                  _deliveryAuthConfirmCodeBloc.add(EditingCode(
                                      textControllers[0].value.text +
                                          textControllers[1].value.text +
                                          textControllers[2].value.text +
                                          textControllers[3].value.text +
                ...
                Center(
                    child: TextButton(
                        onPressed: () {
                          _deliveryAuthConfirmCodeBloc.add(
                              LoadingResendCode(userName, unMaskedPhoneNumber));
                        },
                        child: const Text(
                          "Отправить код повторно",
                          style:
                              TextStyle(color: Color.fromRGBO(56, 144, 208, 1)),
                        ))),
                BlocBuilder<DeliveryAuthConfirmCodeBloc,
                        DeliveryAuthConfirmCodeState>(
                    bloc: _deliveryAuthConfirmCodeBloc,
                        ...
                        return Padding(
                            ...
                            child: const Text('Код успешно отправлен',
                                style: TextStyle(
                                    ...
                                    color: Colors.green,
                                    height: 0.9)));
                      } else if (state is DeliveryAuthConfirmCodeResendFail) {
                        return Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: columnHorizontalPadding),
                            child: Text(state.errorText,
